...
Public Class printPOHistory
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.printPOHistory.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedprintPOHistory
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As printPOHistory = New printPOHistory()
        rpt.Site = Me.Site
        Return rpt
    End Function
