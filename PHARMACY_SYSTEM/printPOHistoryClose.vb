...
Public Class printPOHistoryClose
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "printPOHistoryClose.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.printPOHistoryClose.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedprintPOHistoryClose
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As printPOHistoryClose = New printPOHistoryClose()
        rpt.Site = Me.Site
        Return rpt
    End Function
