...
Public Class printPOHistoryVoid
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.printPOHistoryVoid.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedprintPOHistoryVoid
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As printPOHistoryVoid = New printPOHistoryVoid()
        rpt.Site = Me.Site
        Return rpt
    End Function
