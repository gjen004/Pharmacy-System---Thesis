...
Public Class printRRReports
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.printRRReports.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedprintRRReports
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As printRRReports = New printRRReports()
        rpt.Site = Me.Site
        Return rpt
    End Function
