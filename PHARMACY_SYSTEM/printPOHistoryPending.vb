...
Public Class printPOHistoryPending
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "printPOHistoryPending.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.printPOHistoryPending.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedprintPOHistoryPending
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As printPOHistoryPending = New printPOHistoryPending()
        rpt.Site = Me.Site
        Return rpt
    End Function
